...
[Keyless]
public partial class ViwSystemSchemaAttributesOriginal
{
    [Column("Model_ID")]
    ...
    [StringLength(128)]
    public string AttributeColumn { get; set; } = null!;
    ...
    [StringLength(16)]
    public string AttributeMemberTypeName { get; set; } = null!;
    ...
    [StringLength(1035)]
    public string AttributeFullyQualifiedName { get; set; } = null!;
}
